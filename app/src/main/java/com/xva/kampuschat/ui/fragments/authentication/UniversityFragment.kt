...
import com.xva.kampuschat.ui.adapters.auth.UniversityAdapter
...
class UniversityFragment : Fragment(), Callback<List<University>>,
    ...
    private fun setupAdapter() {
        ...
        var universityAdapter =
            UniversityAdapter(activity!!, list, this)
    ...
    override fun onItemClick(view: View, position: Int) {
        ...
        FragmentHelper.changeFragment("Department",activity!!.supportFragmentManager,1)
