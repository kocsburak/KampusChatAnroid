...
import com.xva.kampuschat.ui.adapters.auth.DepartmentAdapter
...
class DepartmentFragment : Fragment(), Callback<List<Department>>,
    ...
    private fun setupAdapter() {
        ...
        var departmentAdapter =
            DepartmentAdapter(activity!!, list, this)
    ...
    override fun onItemClick(view: View, position: Int) {
        ...
        FragmentHelper.changeFragment("Register", activity!!.supportFragmentManager,1)
    }
